...
//	private final static Log log = LogFactory.getLog(JshowAppAction.class);
	...
	@RequestMapping(value="doAdd",method={RequestMethod.GET,RequestMethod.POST})
	 public @ResponseBody Map<String,Object> doAdd(JshowApp jshowApp, ModelMap context) {
	    ...
	    public @ResponseBody Map<String,Object> doUpdate(JshowApp jshowApp, ModelMap context) {
	    ...
	    public @ResponseBody  Map<String,Object>  doDelete(JshowApp jshowApp) {
