...
//	private final static Log log = LogFactory.getLog(TestUserAction.class);
	...
	@RequestMapping(value="doAdd",method={RequestMethod.GET,RequestMethod.POST})
	 public @ResponseBody Map<String,Object> doAdd(TestUser testUser, ModelMap context) {
	    ...
	    public @ResponseBody Map<String,Object> doUpdate(TestUser testUser, ModelMap context) {
	    ...
	    public @ResponseBody  Map<String,Object>  doDelete(TestUser testUser) {
